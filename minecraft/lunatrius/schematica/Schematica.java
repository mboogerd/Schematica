...
import beyonix.schematica.nbt.NBTPacketHandler;
...
@NetworkMod(channels = { "Schematica" }
	, clientSideRequired = false
	, serverSideRequired = false
	, packetHandler = NBTPacketHandler.class
	, clientPacketHandlerSpec = @SidedPacketHandler(channels = { "Schematica" }, packetHandler = NBTPacketHandler.class)
	, serverPacketHandlerSpec = @SidedPacketHandler(channels = { "Schematica" }, packetHandler = NBTPacketHandler.class))
